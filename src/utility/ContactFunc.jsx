...
export const input_variable="w-full  md:w-1/2 px-2 py-2 font-raleway border-2 border-transparent border-b-dark_green outline-none transition-all duration-300 focus:border-dark_green focus:border-2"
