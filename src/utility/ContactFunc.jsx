...
export const input_variable="px-2 py-3 font-raleway border-2 border-transparent border-b-dark_green outline-none transition-all duration-300 focus:border-dark_green rounded-none focus:border-2 text-base sm:text-sm md:text-md lg:text-md xl:text-md"
