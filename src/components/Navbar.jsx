...
<AnimatePresence>
  {Menu && (
    <motion.div
      ...
      className="fixed top-0 right-0 transform w-2/3 h-full sm:flex-row sm:justify-center sm:items-center bg-primary z-50 flex flex-col transition-transform ease-in-out duration-800 overflow-y-auto"
    >
      {/* Fixed Close Button */}
      <motion.div 
        initial={{ rotate: 0 }}
